...
export default {
  ...
  data() {
    return {
      list: this.$store.state.login.list,
  ...
  methods: {
    change() {
      this.asideList.name = this.name;
      this.asideList.age = this.age;
      this.asideList.nickName = this.nickName;
      this.asideList.school = this.school;
    }
  }
};
</script>
